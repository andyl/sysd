defmodule Sysd do
  @moduledoc """
  Helpers and path constants for Sysd deployments.
  ...
  Each application gets its own subdirectory under `/opt/sysd/`,
  allowing multiple apps to be deployed on the same server.
  """

  @base_path "/opt/sysd"

  @doc "Root path for all Sysd files on the remote server."
